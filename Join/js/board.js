...
/**
 * function to clean the areas
 */
function cleanAreas() {
    document.getElementById("todoArea").innerHTML = "";
...
/**
 * Initiates the function to render the tasks in todoArea 
 * 
...
/**
 * Initiates the function to render the tasks in progressArea 
 * 
 * @param {number} id - number to get the correct task
 */
...
/**
 * Initiates the function to render the tasks in feedbackArea
 * 
 * @param {number} id - number to get the correct task
...
/**
 * Initiates the function to render the progress and assigned in doneArea
 * 
 * @param {number} id - number to get the correct task
 * @param {JSON} task - contains informations for a task
 */
