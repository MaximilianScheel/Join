...
function goToLegal() {
    ...
    localStorage.setItem('selectedMenuItem', 'legal');
}
...
function highlightDestinations() {
    ...
    const bgSummary = document.getElementById('summary_Link');
    const bgBoard = document.getElementById('board_Link');
    const bgTasks = document.getElementById('addtask_Link');
    const bgContacts = document.getElementById('contacts_Link');
    const bgLegal = document.getElementById('legal_Link');

    switch (selectedMenuItem) {
        case 'summary':
            bgSummary.classList.add('menuLinkActive');
            break;
        case 'board':
            bgBoard.classList.add('menuLinkActive');
            break;
        case 'addtask':
            bgTasks.classList.add('menuLinkActive');
            break;
        case 'contacts':
            bgContacts.classList.add('menuLinkActive');
            break;
        case 'legal':
            bgLegal.classList.add('menuLinkActive');
            break;
        default:
            break;
    }
